...
local agent_templates =
{
	...
	sharpshooter_1 =
	{
		...
		--abilities = { "shalem_shootOverwatch", "jackin", "overwatch", "peek", "escape", "melee", "disarmtrap", "overwatchMelee" , "meleeOverwatch", "observePath", "moveBody", "lastWords", "sprint"  },
		...
		upgrades = { "augment_shalem_flavour", "augment_shalem_flavour_2ndry", "item_light_rifle_shalem" },	 --	 "item_invisigel",
	},	
